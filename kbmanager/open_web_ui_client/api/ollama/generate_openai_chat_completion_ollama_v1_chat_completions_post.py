...
from ...models.generate_openai_chat_completion_ollama_v1_chat_completions_post_form_data import (
...
def _get_kwargs(
    *,
    body: GenerateOpenaiChatCompletionOllamaV1ChatCompletionsPostFormData,
