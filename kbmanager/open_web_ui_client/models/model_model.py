...
if TYPE_CHECKING:
    ...
    from ..models.model_model_access_control_type_0 import ModelModelAccessControlType0
    from ..models.model_params import ModelParams


T = TypeVar("T", bound="ModelModel")
...
class ModelModel:
    ...
    Attributes:
        ...
        access_control (Union['ModelModelAccessControlType0', None, Unset]):
    """
    ...
    access_control: Union["ModelModelAccessControlType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.access_control, ModelModelAccessControlType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_access_control(data: object) -> Union["ModelModelAccessControlType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                access_control_type_0 = ModelModelAccessControlType0.from_dict(data)

                return access_control_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ModelModelAccessControlType0", None, Unset], data)
        ...
        model_model.additional_properties = d
        return model_model
